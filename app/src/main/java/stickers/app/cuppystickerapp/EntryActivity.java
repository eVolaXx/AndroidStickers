...
public class EntryActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(stickers.app.cuppystickerapp.R.layout.activity_entry);
        overridePendingTransition(0, 0);
        if (getSupportActionBar() != null) {
            getSupportActionBar().hide();
        }
        progressBar = findViewById(stickers.app.cuppystickerapp.R.id.entry_activity_progress);
    ...
    private void showErrorMessage(String errorMessage) {
        ...
        final TextView errorMessageTV = findViewById(stickers.app.cuppystickerapp.R.id.error_message);
        errorMessageTV.setText(getString(stickers.app.cuppystickerapp.R.string.error_message, errorMessage));
    }
