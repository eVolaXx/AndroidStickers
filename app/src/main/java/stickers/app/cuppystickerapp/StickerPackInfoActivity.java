...
public class StickerPackInfoActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(stickers.app.cuppystickerapp.R.layout.activity_sticker_pack_info);
        ...
        final TextView trayIcon = findViewById(stickers.app.cuppystickerapp.R.id.tray_icon);
        try {
            ...
            final Drawable emailDrawable = getDrawableForAllAPIs(stickers.app.cuppystickerapp.R.drawable.sticker_3rdparty_email);
        ...
        final TextView viewWebpage = findViewById(stickers.app.cuppystickerapp.R.id.view_webpage);
        ...
        final TextView sendEmail = findViewById(stickers.app.cuppystickerapp.R.id.send_email);
        ...
        final TextView viewPrivacyPolicy = findViewById(stickers.app.cuppystickerapp.R.id.privacy_policy);
    ...
    private void launchEmailClient(String email) {
        ...
        startActivity(Intent.createChooser(emailIntent, getResources().getString(stickers.app.cuppystickerapp.R.string.info_send_email_to_prompt)));
    }
